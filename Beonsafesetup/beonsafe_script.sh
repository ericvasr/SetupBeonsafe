...
# Verifica se o arquivo SetupBeonsafe já existe
if [ -e "SetupBeonsafe" ]; then
    echo ""
    rm SetupBeonsafe
fi

# Baixa o script
curl -sSL https://raw.githubusercontent.com/beonsafe/SetupBeonsafe/main/SetupBeonsafe -o SetupBeonsafe
if [ $? -eq 0 ]; then
    echo "14/14 - [ OK ] - Baixando o script"
    # Executa o script baixado
    chmod +x SetupBeonsafe
    ./SetupBeonsafe
else
